    ...
    <>
      <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 
        ...
        <div className='flex items-center gap-4'>
            ...
            <a href="https://www.github.com/sota-mitsumori" target="_blank" rel="noopener noreferrer" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo 
            dark:border-white.50'>
                GitHub <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} alt="" className='w-3'/>
            </a>
